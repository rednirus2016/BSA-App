    ...
    try {
      if (Password !== Newpassword) {
        ...
        const {data} = await axios.post(
          'https://bsagroup.redniruscare.com/api/mr/create/',
          formData,
          {
            headers: {
        ...
        console.log(arr);
        ToastAndroid.show('Welcome to BSA Pharma Inc.!', ToastAndroid.SHORT);
      ...
      <View style={styles.subView}>
        <KeyboardAwareScrollView
          ...
          <View
            ...
            <View
              style={[styles.textinput1, !Password && styles.requiredInput]}>
              <TextInput
                style={styles.nameInput}
            ...
            <View
              style={[styles.textinput1, !Newpassword && styles.requiredInput]}>
              <TextInput
                style={styles.nameInput}
                ref={inputRef6}
            ...
            <Text style={styles.createacctxt}>Company Information</Text>
            ...
            <View
              style={[styles.textinput1, !FAddress && styles.requiredInput]}>
              <TextInput
                style={styles.nameInput}
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate(navigationStrings.LOGIN)}>
              <Text style={[styles.endTxt]}>Already a member?</Text>
            </TouchableOpacity>
          </View>
        </KeyboardAwareScrollView>
      </View>
